...
class EditArticle extends StatelessWidget {
  ...
  EditArticle({required this.articleId}) {
    _loadArticleData();
  }

  void _loadArticleData() {
    final article = _controller.articles.firstWhere(
      (element) => element['id'] == articleId,
      orElse: () => {},
    );

    if (article.isNotEmpty) {
      _controller.title.value = article['title'] ?? '';
      _controller.content.value = article['content'] ?? '';
      _controller.mediaUrls.assignAll(List<String>.from(article['media'] ?? []));
      ...
      child: Scaffold(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextField(
                              controller: TextEditingController(text: _controller.title.value),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 8),
                            TextField(
                              controller: TextEditingController(text: _controller.content.value),
                                ...
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        if (media is String) {
                                          _controller.mediaUrls.remove(media);
        ...
        bottomNavigationBar: Container(
          ...
          child: ElevatedButton(
            onPressed: () async {
              await _controller.editArticle(articleId);
