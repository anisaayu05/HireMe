...
import 'package:HireMe_Id/login/applied/views/applied_view.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:HireMe_Id/login/home/views/home_view_logged_in.dart';
import 'package:HireMe_Id/login/browse/views/browse_view.dart';
import 'package:HireMe_Id/login/profile/views/profile_view.dart';
// import 'package:HireMe_Id/login/applied/views/applied_jobs_view.dart';
// import 'package:HireMe_Id/login/profile/views/profile_view.dart';

class NavbarLoggedIn extends StatelessWidget {
  final RxInt _currentIndex = 0.obs; // State management dengan GetX

  // Daftar halaman yang akan ditampilkan berdasarkan tab
  final List<Widget> _pages = [
    HomeViewLoggedIn(), // Home untuk pengguna login
    BrowseView(),       // Browse untuk mencari pekerjaan
    AppliedView(),  // Halaman pekerjaan yang dilamar
    ProfileView(),      // Halaman profil pengguna
  ];
