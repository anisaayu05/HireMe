...
class AddJobView extends StatelessWidget {
  ...
  void _handleSave() async {
    ...
    try {
      await jobController.addJob(
        ...
        categories:
            selectedCategories.toList(), // Untuk multiple categories, ubah ini
  ...
  void _resetForm() {
    ...
    selectedJobType.value = ''; // Kembali ke default
    selectedCategories.clear(); // Membersihkan semua kategori yang dipilih
    galleryImageUrls.clear(); // Kosongkan galeri gambar
  }
}
